import { AddressTest, ContactTest, UserTest } from "./utils.test";
...
describe("POST /api/contacts/:contactId/addresses/:addressId/update", () => {
  beforeEach(async () => {
    await UserTest.create();
    await ContactTest.create();
    await AddressTest.create();
  ...
  it("should be able to update address", async () => {
    ...
    const response = await supertest(web)
      .post(`/api/contacts/${contact.id}/addresses/${address.id}/update`)
      .set("X-API-TOKEN", "test")
      .send({
        street: "Jalan belum ada",
        city: "Jakarta",
...
describe("DELETE /api/contacts/:contactId/addresses/:addressId/delete", () => {
  beforeEach(async () => {
    await UserTest.create();
    await ContactTest.create();
    await AddressTest.create();
  ...
  it("should be able to remove address", async () => {
    ...
    const response = await supertest(web)
      .post(`/api/contacts/${contact.id}/addresses/${address.id}/delete`)
      .set("X-API-TOKEN", "test");
...
describe("GET /api/contacts/:contactId/addresses/list", () => {
  beforeEach(async () => {
    await UserTest.create();
    await ContactTest.create();
    await AddressTest.create();
  ...
  it("should be able to list addresses", async () => {
    ...
    const response = await supertest(web)
      .get(`/api/contacts/${contact.id}/addresses/list`)
      .set("X-API-TOKEN", "test");
  ...
  it("should reject list address if contact is not found", async () => {
    ...
    const response = await supertest(web)
      .get(`/api/contacts/${contact.id + 1}/addresses/list`)
      .set("X-API-TOKEN", "test");
